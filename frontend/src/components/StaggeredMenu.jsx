...
export const StaggeredMenu = ({
  ...
  return (
    <div
      className={`sm-scope z-40 ${isFixed && open ? "fixed top-0 left-0 w-screen h-screen overflow-hidden" : isFixed ? "fixed top-0 right-0 w-auto h-auto" : "relative inline-flex"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
